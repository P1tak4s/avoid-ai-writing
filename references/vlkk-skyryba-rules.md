# VLKK Lietuvių kalbos skyryba (2020)
# Šaltinis: https://www.vlkk.lt/media/public/file/Leidiniai/Liet_k_skyryba.pdf
# Praktinės taisyklės svetainių tekstams
...
- `Girdėti, kad situacija keičiasi.`
- `Rodos, tai geriausias pasirinkimas.`

**Dažni įterpiniai svetainėse:**
| Įterpinys | Pavyzdys |
|---|---|
| `pvz.,` | `Siūlome paslaugas, pvz., diagnostiką, remontą.` |
| `t. y.,` | `Garantija, t. y., nemokamas taisymas, galioja metus.` |
| `tiksliau,` | `Per savaitę, tiksliau, per 5 darbo dienas.` |
| `žinoma,` | `Žinoma, kiekvieną atvejį vertiname atskirai.` |
...
- `Reikės: paso kopijos, paraiškos formos, patvirtinimo.`

### Prieš aiškinimą
- `Garantija veikia paprastai: atvykstate, patikriname, taisome nemokamai.`
- `Principas vienas: žinote kainą iš anksto.`
...
```
Registruodamiesi gaunate:
1. Nemokamą paskyrą su visa istorija.
2. Priminimai prieš kiekvieną apsilankymą.
...
Leistinas tik ekspresyviose antraštėse arba citatose.
...
**AI klaida:** angliškos kabutės `"..."` vietoje lietuviškų `„..."`.
...
- `Per savaitę sutvarkysite visus reikalus.`
- `Nuo pirmadienio iki penktadienio dirbame.`

---

## Dažnos AI skyrybos klaidos svetainėse
...
| `Be abejo rezultatai geri` | `Be abejo, rezultatai geri.` | Kablelis po įterpinio |
| `Diagnostika greita ir tiksli kainuoja 30 €` | `Diagnostika – greita ir tiksli – kainuoja 30 €` | Įspraudas su brūkšniais |
| `Mūsų tikslas yra kokybė` | `Mūsų tikslas – kokybė` | Brūkšnys vietoje „yra" |
