...
**Techniniai reikalavimai:**
- Maksimumas: **160 simbolių**
- Minimumas: 120 simbolių
- Turi skatinti paspausti (CTR)

**Struktūra:**
```
[Ką gauna klientas] + [Konkretus privalumas] + [CTA]
```
...
- ❌ Per trumpas: `Automobilių servisas Vilniuje.` (tik 32 simboliai)
...
- H1 = title tag + šiek tiek plačiau arba tas pats
- Turi turėti pagrindinį rakažodį
- Žmogiškai skambantis, ne robotiškas
...
- Gali turėti antrinius rakažodžius
- Aiškiai atsako į klausimai arba aprašo sekciją

**Pavyzdžiai:**
- `Mūsų paslaugos` → geriau: `Ką tvarkome` arba `Paslaugos Vilniuje`
- `Apie mus` → geriau: `10 metų automobilių remonto patirtis`
- `Kodėl mes?` → geriau: `Kodėl klientai grįžta pas mus`
...
**Taisyklės:**
- Mažosios raidės
- Brūkšniai vietoj tarpų: `automobiliu-servisas`
- Be lietuviškų raidžių URL: `automobiliu` (ne `automobilių`)
- Trumpi ir aiškūs

**Pavyzdžiai:**
- ✅ `revmotors.lt/paslaugos`
- ✅ `revmotors.lt/variklio-remontas`
- ✅ `revmotors.lt/kontaktai`
- ❌ `revmotors.lt/page?id=123`
- ❌ `revmotors.lt/automobiliu-remonto-ir-techninio-aptarnavimo-paslaugos`
...
interneto svetainių kūrimas Klaipėdoje
```

---

## Teksto ilgis skirtingiems puslapiams

| Puslapis | Rekomenduojamas ilgis |
|---|---|
| Pagrindinis (Home) | 300–600 žodžių |
| Paslaugos (bendras) | 400–800 žodžių |
| Viena paslauga | 600–1200 žodžių |
| Apie mus | 300–600 žodžių |
| Blog straipsnis | 800–2000 žodžių |
| Kontaktai | 100–200 žodžių |

---

## Lietuviški SEO copy pavyzdžiai

### Servisas / meistras
**Title:** `Automobilių servisas Vilniuje | RevMotors`
**H1:** `Automobilių servisas Vilniuje`
**Meta:** `Remontuojame per dieną. Diagnostika 30 €, variklio remontas nuo 150 €. Dirbame I–VI. Registruokitės telefonu arba internetu.`

### SaaS / programa
**Title:** `Buhalterinė programa smulkiam verslui | AccountPro`
**H1:** `Buhalterinė apskaita be buhalterio`
...
**Alt tekstai prie nuotraukų:**
- ❌ `img001.jpg`
- ❌ `nuotrauka`
- ✅ `automobilių servisas vilniuje variklio remontas`
- ✅ `revmotors dirbtuvė vilniuje`
