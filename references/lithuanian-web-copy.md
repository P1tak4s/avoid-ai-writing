# Lietuviško svetainės teksto gidas
...
## Gramatika kurią Claude dažnai supainioja

### Liepiamoji nuosaka (CTA mygtukai ir raginiai)
| Klaidingai | Teisingai |
|---|---|
| Registruojies | Registruokis |
| Prisijungies | Prisijunk |
| Susisiekies | Susisiek |
| Išbandykis | Išbandyk |
| Sužinokis | Sužinok |
| Pradėkis | Pradėk |
...
| Klaidingai | Teisingai |
|---|---|
| registruojies | registruojiesi |
| prisijungies | prisijungi |
...
## Angliški kalkai kurių reikia vengti

| Angliškas kalkas | Natūralus lietuviškas atitikmuo |
|---|---|
| be galvos skausmo | be rūpesčių / paprastai / lengvai |
| darbai eina pas tave | klientai randa tave / užsakymai ateina patys |
| valdyti lūkesčius | aiškiai susitarti / žinoti ko tikėtis |
| kita lygmeniu | geriau / aukščiau / stipriau |
| tai keičia žaidimą | tai keičia viską / tai svarbu |
| galutinis rezultatas | rezultatas / pabaigoje |
| investicija į save | verta / atsipirks |
| 24/7 | visą parą / visada |
| realiu laiku | iš karto / tiesioginiai |
| sklandžiai | lengvai / be trikdžių |
| optimizuoti | pagerinti / sutvarkyti / suderinti |
| implementuoti | įdiegti / pradėti naudoti / pritaikyti |
| kontentas | turinys |
| featureai | funkcijos / galimybės |
| onboardinti | priimti / apmokyti / įvesti |
| deliverinti | pristatyti / pateikti |
...
Arba be brūkšnio visai:
- Užsakovai randa tave per paiešką
- Sąskaitas išrašo sistema automatiškai
- Pinigus gauni per 2 dienas

---

## Hero sekcija (pagrindinis antraštė + paantraštė)

### Struktūra kuri veikia
- **Antraštė:** konkretus pažadas arba rezultatas (1-2 sakiniai maks.)
- **Paantraštė:** kaip tai veikia arba kam skirta (2-3 sakiniai)
- **CTA:** veiksmažodis liepiamąja nuosaka

**Blogai:**
> „Inovatyvios skaitmeninės sprendimų platformos ekosistema verslui"
...
| Tikslas | Variantai |
|---|---|
| Registracija | Registruokis / Pradėk nemokamai / Kurk paskyrą |
| Kontaktas | Susisiek / Rašyk mums / Skambink |
| Daugiau info | Sužinok daugiau / Žiūrėk kaip veikia / Pasakyk man daugiau |
| Pirkimas | Pirkti / Užsisakyti / Gauti |
| Demo | Išbandyk / Žiūrėk demo / Parodyk man |

**Venk:** „Klikštelėkite čia", „Spauskite", „Paspauskite mygtuką"

---

## Paslaugų aprašymų šablonai

### Servisas / meistras
```
[Paslauga] [mieste].
[Konkretus privalumas #1].
[Konkretus privalumas #2].
[CTA].
```
...
Pavyzdys:
> Visi tavo užsakymai vienoje vietoje.
> Prisijungi, matai kas laukia, dirbi.
> Jokie Excel failai, jokie popieriai.
...
## Tikros frazės kurios veikia lietuviškuose tekstuose

- „Dirba kaip laikrodis"
- „Vieta kur..."
- „Jokie [X], jokie [Y]" (pvz. „Jokie Excel failai, jokie popieriai")
- „Tai ir viskas"
- „Greičiau nei manai"
- „Žinai kiek mokėsi iš anksto"
- „Susitariam per 5 minutes"
- „Be jokių staigmenų"
- „Remontuojame per dieną, ne per savaitę"
